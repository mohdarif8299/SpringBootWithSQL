...
<body class="container" style="padding:10px" onload="document.refresh();">
<h2>DELETED EMPLOYEE DETAILS</h2>
<p><b>EMPLOYEE ID</b>${deleted_employee.id }</p>
<p><b>EMPLOYEE NAME</b>${deleted_employee.name }</p>
<p><b>EMPLOYEE DESIGNATION</b>${deleted_employee.designation }</p>
<p><b>EMPLOYEE EXPERTISE</b>${deleted_employee.expertise }</p></div>
